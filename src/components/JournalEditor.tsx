...
import { JournalEntry, ReflectionMode, YouTubeAttachment } from '../types';
import { Sparkles, Save, Tag, Smile, Lightbulb, RotateCw, AlertCircle, Video, Plus, X, ExternalLink, Clock } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <div className="relative">
            ...
            {isContextMenuOpen && (
              <div className="absolute right-0 mt-1.5 w-48 bg-stone-900 border border-stone-800 rounded-xl shadow-2xl z-30 py-1 overflow-hidden animate-in fade-in zoom-in-95 duration-100">
                <button
